package com.example.usersmanagementservletjsp.user.domain.enums;

import com.example.usersmanagementservletjsp.user.domain.exceptions.InvalidUserRoleException;
